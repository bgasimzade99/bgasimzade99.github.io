...
export default function Footer() {
  ...
  return (
    <footer
      className="relative py-16 lg:py-20 border-t border-white/[0.06]"
      role="contentinfo"
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          >
            <Link
              href="/#home"
              className="inline-block text-lg font-semibold tracking-[0.12em] mb-4 hover:opacity-90 transition-opacity"
              style={{
            ...
            <div className="flex gap-4">
              <a
                ...
                aria-label="LinkedIn"
                className="p-2.5 rounded-xl bg-white/[0.04] border border-white/[0.06] text-white/55 hover:text-teal-400 hover:border-teal-500/30 transition-all duration-200"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="BGDev Official"
                className="group p-2.5 rounded-xl bg-white/[0.04] border border-white/[0.06] text-white/55 hover:text-teal-400 hover:border-teal-500/30 transition-all duration-200"
              >
                <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24" fill="none" aria-hidden>
                  <defs>
                    <linearGradient id="bgdev-footer-icon" x1="0%" y1="0%" x2="100%" y2="100%">
                  ...
                  {/* B + G monogram */}
                  <path
                    fill="url(#bgdev-footer-icon)"
                    d="M5 4h2.2c2.5 0 4.3 1.8 4.3 4.2 0 1.4-.6 2.6-1.6 3.4.9.7 1.5 1.8 1.5 3.1 0 2.5-1.9 4.5-4.4 4.5H5V4zm1.5 6.2h.7c1.3 0 2.2-.9 2.2-2.2s-.9-2.2-2.2-2.2h-.7v4.4zm0 5.6h1.2c1.5 0 2.6-1.1 2.6-2.5s-1.1-2.5-2.6-2.5H6.5v5z"
                  />
                  <path
                    fill="url(#bgdev-footer-icon)"
                    d="M13.5 8.5c-2.5 0-4.5 2-4.5 4.5s2 4.5 4.5 4.5 4.5-2 4.5-4.5-2-4.5-4.5-4.5zm0 1.5c1.7 0 3 1.3 3 3s-1.3 3-3 3-3-1.3-3-3 1.3-3 3-3zm-1 2.5v2h2.5v1h-2.5v2.5h-1.2v-6h3.7v1h-2.5z"
                  />
                </svg>
              </a>
              <a
          ...
          >
            ...
            {profile.socials.phone && (
              <a
                ...
                className="block text-white/55 hover:text-teal-400 text-sm transition-colors duration-200"
              >
                {profile.socials.phone}
              </a>
            )}
